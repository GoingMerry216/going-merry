 ...
 */
@RestController
@RequestMapping(value = Constants.API_PREFIX + "/article")
@Api(value = "Article控制类", description = "控制类接口测试")
public class ArticleController {
    ...
    public Result
<PageInfo<Article>> list(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
