...
import static com.sdu.software.goingmerry.core.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/going_merry"+ "?serverTimezone=GMT%2B8";
    ...
    private static final String AUTHOR = "Liyp";//@author
